...
- Existing tests: the six-package baseline is green at `origin/main`; this new package starts with TDD tests. Existing release seams are characterized before modification.
...
|---|---|---|---|---|
| 1 — Build the safety net | working-with-legacy-code | in-progress | TESTING.md + TECH-DEBT.md (GATE) | 2026-08-29 |
...
- [ ] Add the Phase 1 RED tests and characterize all release/profile seams that will change (Codex, now).
- [ ] Implement only behavior pinned in the Safety Net Map (Codex, now).
- [ ] Complete the clean-code, refactoring, deep-module, and dependency-rule audits (Codex, before candidate build).
