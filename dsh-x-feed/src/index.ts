...
export const X_FEED_CONTRACT = [
  ...
  '- 具体单条 like/save 作为 X 反馈只进 X 反馈账本，不进长期 canary memory；当前消息若还明确表达很感兴趣、保存后继续看或以后研究，x_feed 写入不能替代探索合同的独立记录。',
  '- X 收藏不另建 Markdown、research 文件或其他平行收藏池；探索合同命中时只使用它自己的探索账本。',
